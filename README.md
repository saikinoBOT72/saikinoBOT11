...
| 🗳️ 予想大会 | お題と選択肢を立てて、みんなで賭ける。**集まった全額を正解者で山分け**。人気のない選択肢を当てるほど儲かる |
...
**🎮 あそぶ → 🗳️ 予想大会 → 🆕 お題を立てる** から、お題・選択肢（改行区切りで2〜5個）・締切・参加費を入れます。参加費を空欄にすると、各自が好きな額を賭けられます。
