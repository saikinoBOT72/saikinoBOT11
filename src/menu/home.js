        ...
        fields: [
          {
            ...
            value:
              ...
              '\n管理者が **⚙️ 管理 → 📌 報告パネルを置く** をすると、専用チャンネルにボタンだけのメッセージが残ります。以後は `/menu` を開かずワンタップで報告できます。',
          },
          {
            name: '🔥 連日ボーナス・🏅 称号',
            value:
          ...
          },
          {
            name: '🎮 あそぶ（1人）',
            value:
              'スロット（最大 x3000）、コイントス（2倍）、ハイ&ロー（連勝で倍率上昇）、運命の扉（赤か青を当て続ける）、宝くじ（毎週日曜19時に抽選・持ち越しあり）。',
          },
          {
            name: '🎮 あそぶ（1対1）',
            value:
              'じゃんけん、チンチロ、ロシアンルーレット、チャージ＆シュート、地雷＆陣取り。相手を選んで挑戦状を送り、承諾されたら勝負開始です。**勝った方が賭け金を総取り**します。',
          },
          {
            name: '🛍️ ショップ',
            value:
