      ...
      withNotice(
        embed({
          ...
          description:
            ...
            'そのあと「勝負」「レイズ」「降りる」を決めて、残った人で役を比べます。\n\n' +
          ...
          fields: [
            ...
            { name: '　', value: '＞ スリーカード ＞ ツーペア ＞ ワンペア ＞ ハイカード' },
            {
              name: 'レイズ',
              value:
                '半額・同額・好きな額から選べます（卓の1人だけ、1回だけ）。\n' +
                '誰かが上げると**残り全員からもその場で預かり**、追うか降りるかをもう一度決めます。' +
                '降りれば預かったぶんは返ります。',
            },
            { name: '降りたら', value: '出したぶんだけの負け。場に残ります', inline: true },
            { name: '全員降りたら', value: '不成立。全額返ります', inline: true },
          ],
        }),
        notice,
      ),
